                            ...
                            @forelse ($rents as $rent)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        @can('houserent.manage')
                                        <a href="{{ route('house-rents.edit', $rent) }}" class="text-indigo-600 hover:text-indigo-900 ml-2">Edit</a>
                                        <form action="{{ route('house-rents.destroy', $rent) }}" method="POST" class="inline-block ml-2" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                            @method('DELETE')
