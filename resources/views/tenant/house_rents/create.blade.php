                    ...
                    <form action="{{ route('house-rents.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <select name="status" id="status" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="pending" {{ old('status', 'pending') == 'pending' ? 'selected' : '' }}>{{ __('house_rent.pending') }}</option>
                                <option value="paid" {{ old('status') == 'paid' ? 'selected' : '' }}>{{ __('house_rent.paid') }}</option>
                                <option value="partial" {{ old('status') == 'partial' ? 'selected' : '' }}>{{ __('house_rent.partial') }}</option>
                            </select>
