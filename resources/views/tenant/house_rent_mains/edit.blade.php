                    ...
                    <form method="POST" action="{{ route('house-rent-mains.update', $houseRentMain) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Month cannot be changed.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="status" name="status" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="pending" {{ $houseRentMain->status === 'pending' ? 'selected' : '' }}>Pending</option>
                                    <option value="partial" {{ $houseRentMain->status === 'partial' ? 'selected' : '' }}>Partial</option>
                                    <option value="paid" {{ $houseRentMain->status === 'paid' ? 'selected' : '' }}>Paid</option>
                                </select>
