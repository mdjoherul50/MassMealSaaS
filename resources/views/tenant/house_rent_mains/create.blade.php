<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('house_rent.add_house_rent_month') }}
        </h2>
    </x-slot>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="status" name="status" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="pending">{{ __('house_rent.pending') }}</option>
                                    <option value="partial">{{ __('house_rent.partial') }}</option>
                                    <option value="paid">{{ __('house_rent.paid') }}</option>
                                </select>
