            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('superadmin.roles.update', $role) }}" method="POST">
                        ...
                        <div class="mt-4">
                            <x-input-label for="slug" :value="__('role.role_slug')" />
                            <x-text-input id="slug" class="block mt-1 w-full" type="text" name="slug" :value="old('slug', $role->slug)" required />
